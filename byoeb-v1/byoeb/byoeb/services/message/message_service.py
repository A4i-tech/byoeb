"""
Message Service for managing message-related operations.
"""
import pandas as pd
...
from byoeb.services.leaderboard.time_window_strategies import TimeWindowStrategy, TimeWindowFactory
...
class MessageService(BaseMongoDBService):
    """Service class for message-related operations."""

    def __init__(self, user_service: UserService, config=None, mongo_db_factory: MongoDBFactory = None):
        ...
        self._repository_factory = None  # Initialized lazily

    async def _get_repository_factory(self):
    ...
    async def get_messages_by_user(
        ...
        return await message_repository.read_all(query, limit=limit)
    ...
    # MongoDB-specific methods (consolidated from MessageMongoDBService)
