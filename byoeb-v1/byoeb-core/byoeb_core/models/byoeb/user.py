...
class User(BaseModel):
    ...
    created_timestamp: Optional[int] = Field(default=None, description="Timestamp when the user was created", examples=[1633028300])
    activity_timestamp: Optional[int] = Field(default=None, description="Timestamp of the user's last activity", examples=[1633028301])
