...
class TemplateParameter(BaseModel):
    ...
    text: Optional[str] = Field(default=None, description="Text content of the parameter.")
...
class Template(BaseModel):
    ...
    components: Optional[List[TemplateComponent]] = Field(default=None, description="List of components for the template.")
