...
class WhatsAppResponseStatus(BaseModel):
    ...
    error: Optional[str] = Field(default=None, description="The error message if the message failed")
...
class WhatsAppResponse(BaseModel):
    ...
    media_message: Optional[MediaMessage] = Field(default=None, description="The media message being sent")