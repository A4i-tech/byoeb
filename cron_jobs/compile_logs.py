...
utils.delete_rows(SCOPES, SPREADSHEET_ID, ASHA_LOGS_RANGE_NAME, local_path, 1, len(final_asha_df)+2)
utils.delete_rows(SCOPES, SPREADSHEET_ID, ANM_LOGS_RANGE_NAME, local_path, 1, len(final_anm_df)+2)
